...
from chat_mcp.agents.knowledge_agent import KnowledgeAgent

from .common import get_messages_from_state, get_context_from_state, resolve_user_input


def make_knowledge_agent_node(tenant_id: str, tools_for_agent: List[Any]):
    async def node(state: ChatState, config: RunnableConfig) -> ChatState:
        ...
        try:
            ...
            print(f"[ORCH-AGENT] Error in knowledge node: {e}")
            error: Dict[str, Any] = {
