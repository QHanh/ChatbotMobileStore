...
class KnowledgeAgent:
    ...
    def _select_tools(self, tenant_tools):
        ...
        default_tools = []
        if "knowledge_graphrag" in tools_by_name:
            default_tools.append(tools_by_name["knowledge_graphrag"])
        extra_tools = [
            t
    ...
    async def run(self, context: AgentContext) -> AgentResult:
        ...
        if llm is None:
            ...
            return AgentResult(
                answer="Hiện tại em chưa được cấu hình LLM cho agent tri thức.",
        ...
        try:
            ...
            observations.append(f"knowledge_agent_create_agent_error: {e}")
